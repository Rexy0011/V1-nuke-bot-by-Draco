...
class Title:
    ...
    def update_title(self):
            try:
                ...
                title = f'Leon | G: {genned} | E: {errors} | S: {solved} | U: {unlocked} | L: {locked} | Unlock Rate: {unlock_rate}% | Elapsed: {round(time() - genStartTime, 2)}s |'
...
class Utils:
    ...
    @staticmethod
    def GetPronouns():
        pronouns = ["he/him", "she/her","they/them","Leon/On" , "Ask me","it/its","Cool/Hot"]
